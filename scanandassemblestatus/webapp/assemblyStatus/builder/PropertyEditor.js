sap.ui.define([
    ...
    "use strict";
    var oFormContainer;
    return PropertyEditor.extend( "rits.assembly.custom.plugin.scanandassemblestatus.assemblyStatus.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("rits.assembly.custom.plugin.scanandassemblestatus.assemblyStatus.i18n.builder");
			this.setPluginResourceBundleName("rits.assembly.custom.plugin.scanandassemblestatus.assemblyStatus.i18n.i18n");
		},
