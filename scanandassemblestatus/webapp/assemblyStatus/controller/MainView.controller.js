sap.ui.define([
    ...
    "use strict";
    return PluginViewController.extend("rits.assembly.custom.plugin.scanandassemblestatus.assemblyStatus.controller.MainView", {
        onInit: function () {
        ...
        fetchMachineStatus: function(){
			...
			var url = this.getPublicApiRestDataSourceUri() +
				"/pe/api/v1/process/processDefinitions/start?key=REG_551bcc9d-7b1d-4c3c-ac23-97c5b8fc06f5&async=false";
			var that = this;
